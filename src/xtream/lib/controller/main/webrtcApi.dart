...
class WebRtcApi {
  ...
  Future<String> createRoom(RTCVideoRenderer remoteRenderer) async  {
    ...
    peerConnection?.onTrack = (RTCTrackEvent event) {
      ...
      event.streams[0].getTracks().forEach((track) {
        print("Add a track to the remote room: $track");
        remoteStream?.addTrack(track);
      });
    };

    roomRef.snapshots().listen((snapshots) async {
      print("Got updated room: ${snapshots.data()}");
  ...
  Future<void> openUserMedia(RTCVideoRenderer localVideo, RTCVideoRenderer remoteVideo, bool mic, bool cam) async {
    var stream = await navigator.mediaDevices
        .getUserMedia({'video': mic, 'audio': cam});
  ...
  void updateVideo(RTCVideoRenderer localVideo, bool value) {
